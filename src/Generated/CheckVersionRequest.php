...
/**
 * Description of CheckVersionRequest
 *
 * @author 陈浩波
 */
class CheckVersionRequest {
    ...
    */
    ...
    public function serialize(Oarchive &$out, string $tag, CheckVersionRequest &$v): int {
    ...
    public function unserialize(Iarchive &$in, string $tag, CheckVersionRequest &$v): int {
