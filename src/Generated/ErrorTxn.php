...
class ErrorTxn {
    ...
    */
    public $err;	      //int32_t
    public function serialize(Oarchive &$out, string $tag, ErrorTxn &$v): int {
    ...
    public function unserialize(Iarchive &$in, string $tag, ErrorTxn &$v): int {
