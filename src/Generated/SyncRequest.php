...
class SyncRequest
{
    ...
    */
    ...
    public function serialize(Oarchive &$out, string $tag, SyncRequest &$v) : int {
    ...
    public function unserialize(Iarchive &$in, string $tag, SyncRequest &$v) : int {
